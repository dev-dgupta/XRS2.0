...
import com.iontrading.practice.MyApplicationModule;
import com.iontrading.practice.persistBean.ApplicationPNConfiguration;
import com.iontrading.practice.persistBean.xrsSample.DataQueryModule;
...
//                .withModules(MyApplicationModule.class, ApplicationPNConfiguration.class)
                .withModules(DataQueryModule.class)
